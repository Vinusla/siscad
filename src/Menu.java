...
public class Menu {
	...
	public static void PrintMenuPrincipal(){
		System.out.println("------Sistema acad�mico vers�o 0.01------");
	...
	public static void InserirProfessorCurso(){
		...
		System.out.println("Digite o ID do curso ao qual voc� deseja acrescentar o professor: ");
	...
	public static void CadDisciplina(){
		...
		System.out.println("Digite a �rea da disciplina: ");
	...
	public static void AtualizarDisciplina(){
		...
		String nome=form.nextLine();
		disciplina.setNome(nome);
		System.out.println("Digite a nova �rea da disciplina: ");
		String area=form.nextLine();
		disciplina.setArea(area);
